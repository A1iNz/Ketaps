...
<head>
    ...
    <title>Siap Lulus Ketapang — Portal Lengkap</title>
...
<body>
    ...
    <script>
        ...
        function setLRole(r) {
            currentRole = r;
            ['siswa', 'perus', 'lpk'].forEach(x => document.getElementById('rt-' + x).classList.remove('on'));
            document.getElementById('rt-' + r).classList.add('on')
        }

        function setRRole(r) {
            ['siswa', 'perus', 'lpk'].forEach(x => {
        ...
        function enterApp(role) {
            ...
            b.textContent = labels[role] || 'SISWA';
