...
<head>
  ...
  <title>{{ __('Login') }} — {{ config('app.name', 'Siap Lulus Ketapang') }}</title>
...
<body>
  ...
  <div class="container">
    <div class="brand">
      ...
      <div>
        <div class="brand-name">{{ config('app.name', 'Siap Lulus Ketapang') }}</div>
        <div class="brand-sub">Platform Karier & Belajar</div>
      </div>
    </div>

    <div class="login-card">
      <div class="login-title">{{ __('Masuk') }}</div>
      <div class="login-subtitle">{{ __('Masuk ke akun Anda untuk melanjutkan') }}</div>
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
          ...
          <input id="password" class="form-input" type="password" name="password" required autocomplete="current-password" placeholder="Password Anda" />
        </div>
