...
<head>
  ...
  <title>{{ __('Reset Password') }} — {{ config('app.name', 'Siap Lulus Ketapang') }}</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="reset-card">
      ...
      <div class="reset-subtitle">{{ __('Lupa password? Masukkan email Anda dan kami akan mengirim link reset password.') }}</div>
